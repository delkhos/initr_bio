...
_lr_productions = [
  ...
  ('gate2 -> AND','gate2',1,'p_gate2','verilog.py',144),
  ('gate2 -> OR','gate2',1,'p_gate2','verilog.py',145),
  ('gate2 -> NAND','gate2',1,'p_gate2','verilog.py',146),
  ('gate2 -> XOR','gate2',1,'p_gate2','verilog.py',147),
  ('gate2 -> NOR','gate2',1,'p_gate2','verilog.py',148),
  ('empty -> <empty>','empty',0,'p_empty','verilog.py',152),
]
